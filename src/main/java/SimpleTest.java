...
public class SimpleTest {
    public static void main(String args[]) throws Exception {
        ...
        PrivateKey pk = null;
        NetworkedGroupMember<PBFTCohort.Client> clientNetworkedGroupMember = new NetworkedGroupMember<PBFTCohort.Client>("server1", 1, new InetSocketAddress("localhost", 9001), PBFTCohort.Client.class, null, Optional.fromNullable(pk));
