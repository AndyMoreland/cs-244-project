...
public class PrePrepareMessage implements org.apache.thrift.TBase<PrePrepareMessage, PrePrepareMessage._Fields>, java.io.Serializable, Cloneable, Comparable<PrePrepareMessage> {
  ...
  public PrePrepareMessage setSequenceNumber(int sequenceNumber) {
    this.sequenceNumber = sequenceNumber;
    setSequenceNumberIsSet(true);
    return this;
  }
  ...
  public PrePrepareMessage setViewId(int viewId) {
    this.viewId = viewId;
    setViewIdIsSet(true);
    return this;
  }
  ...
  public PrePrepareMessage setTransactionDigest(String transactionDigest) {
    this.transactionDigest = transactionDigest;
    return this;
  }
  ...
  public PrePrepareMessage setMessageSignature(String messageSignature) {
    this.messageSignature = messageSignature;
    return this;
  }
