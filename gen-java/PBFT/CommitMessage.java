...
public class CommitMessage implements org.apache.thrift.TBase<CommitMessage, CommitMessage._Fields>, java.io.Serializable, Cloneable, Comparable<CommitMessage> {
  ...
  public String checkpointDigest; // required
  ...
  public String getCheckpointDigest() {
    return this.checkpointDigest;
  }

  public CommitMessage setCheckpointDigest(String checkpointDigest) {
    this.checkpointDigest = checkpointDigest;
    return this;
  }
  ...
  public CommitMessage setMessageSignature(String messageSignature) {
    this.messageSignature = messageSignature;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case CHECKPOINT_DIGEST:
      if (value == null) {
        ...
        setCheckpointDigest((String)value);
      }
      break;
  ...
  public int hashCode() {
    ...
    boolean present_checkpointDigest = true && (isSetCheckpointDigest());
    list.add(present_checkpointDigest);
    if (present_checkpointDigest)
      list.add(checkpointDigest);
  ...
  private static class CommitMessageStandardScheme extends StandardScheme<CommitMessage> {
        ...
        switch (schemeField.id) {
          ...
          case 2: // CHECKPOINT_DIGEST
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              struct.checkpointDigest = iprot.readString();
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, CommitMessage struct) throws org.apache.thrift.TException {
      ...
      if (struct.checkpointDigest != null) {
        ...
        oprot.writeString(struct.checkpointDigest);
        oprot.writeFieldEnd();
      }
