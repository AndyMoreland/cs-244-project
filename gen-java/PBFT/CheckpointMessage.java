...
public class CheckpointMessage implements org.apache.thrift.TBase<CheckpointMessage, CheckpointMessage._Fields>, java.io.Serializable, Cloneable, Comparable<CheckpointMessage> {
    ...
    int replicaId)
  {
    ...
    this.checkpointDigest = org.apache.thrift.TBaseHelper.copyBinary(checkpointDigest);
  ...
  public ByteBuffer bufferForCheckpointDigest() {
    return org.apache.thrift.TBaseHelper.copyBinary(checkpointDigest);
  }

  public CheckpointMessage setCheckpointDigest(byte[] checkpointDigest) {
    this.checkpointDigest = checkpointDigest == null ? (ByteBuffer)null : ByteBuffer.wrap(Arrays.copyOf(checkpointDigest, checkpointDigest.length));
    return this;
  }
