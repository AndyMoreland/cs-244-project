      ...
      if (incoming.get(2)) {
        {
          ...
          CheckpointMessage _elem11;
          for (int _i12 = 0; _i12 < _set10.size; ++_i12)
          {
            _elem11 = new CheckpointMessage();
            _elem11.read(iprot);
            struct.checkpointProof.add(_elem11);
          }
        }
        struct.setCheckpointProofIsSet(true);
      }
      if (incoming.get(3)) {
        {
          ...
          PrePrepareMessage _elem14;
          for (int _i15 = 0; _i15 < _set13.size; ++_i15)
          {
            _elem14 = new PrePrepareMessage();
            _elem14.read(iprot);
            struct.preparedGreaterThanSequenceNumber.add(_elem14);
          }
        }
        struct.setPreparedGreaterThanSequenceNumberIsSet(true);
      }
